    ...
    <div class="mx-auto md:mx-0 mb-8 md:mb-0">
        ...
        <div class="min-w-72 md:min-w-0 w-max">
            ...
            <div class="flex justify-between">
                <!-- Instagram -->
                <x-footer-link href="https://www.instagram.com/roquematcon?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
                    <svg class="size-6 fill-border-color group-hover:fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Facebook -->
                <x-footer-link href="https://www.facebook.com/roqueac">
                    <svg class="size-6 fill-border-color group-hover:fill-white" viewBox="0 0 11 22" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M10.315 3.9578C9.6917 3.83314 8.84983 3.74 8.32037 3.74C6.8867 3.74 6.79358 4.36333 6.79358 5.36066V7.13607H10.3774L10.065 10.8137H6.79358V22H2.30632V10.8137H0L0 7.13607H2.30632V4.86127C2.30632 1.74533 3.77079 0 7.44771 0C8.72517 0 9.66017 0.187001 10.8753 0.436334L10.315 3.9578Z" />
                    </svg>
                </x-footer-link>

                <!-- Youtube -->
                <x-footer-link href="https://www.youtube.com/@RoqueMatconEstrutural">
                    <svg class="size-6 fill-border-color group-hover:fill-white" viewBox="0 0 26 18" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- LinkedIn -->
                <x-footer-link href="https://www.linkedin.com/company/roque-a-o-e-cimento/">
                    <svg class="size-6 fill-border-color group-hover:fill-white" viewBox="0 0 22 21" xmlns="http://www.w3.org/2000/svg">
