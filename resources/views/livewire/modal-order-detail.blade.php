<div>
    @if (!is_null($order))
        ...
        <div class="flex space-x-2 md:space-x-4 justify-end">
            <a href="{{ $order->nmArquivoDetalhes ?? '#' }}" {{ $order->nmArquivoDetalhes ? 'download' : '' }} class="flex justify-center space-x-2 items-center w-72 border border-primary bg-transparent rounded-lg text-normal font-medium text-primary leading-none py-2 px-2 md:px-4 hover:bg-primary-100 active:bg-primary-200 focus:outline-none transition ease-in-out duration-150">
