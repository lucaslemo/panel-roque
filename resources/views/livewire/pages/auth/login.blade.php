...
<div>
    ...
    <form wire:submit="login">
        ...
        <p class="font-medium text-black text-normal lg:text-lg mb-6 lg:mb-10">Informe seu CPF e senha para acessar o seu portal:</p>

        <!-- CPF -->
        <div class="group-label-input mb-4 lg:mb-6">
        ...
        <!-- Password -->
        <div class="mt-4 group-label-input mb-4 lg:mb-8">
        ...
        <div class="flex justify-between items-center mb-4 lg:mb-8">
                <label for="remember" class="inline-flex items-center">
                    ...
                    <span class="ms-2 lg:ms-3 text-subtitle lg:text-normal font-normal text-label-color">{{ __('Remember me') }}</span>
                </label>

            @if (Route::has('password.request'))
                <a class="text-subtitle lg:text-normal text-primary hover:text-primary-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary" href="{{ route('password.request') }}" wire:navigate>
