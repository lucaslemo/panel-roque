<div>
    <div class="bg-white rounded-lg shadow-card p-4 md:p-6">
        ...
        <div class="relative space-y-6 mb-6">
            @foreach ($lastOrders as $lastOrder)
                <div class="grid grid-cols-5 sub-middle:grid-cols-6 laptop:grid-cols-5 middle:grid-cols-6 gap-x-1 bg-background rounded-lg items-center px-4 xl:px-8 py-4">
                    <!-- Data do pedido -->
                    ...
                    <div class="flex flex-row col-span-1 space-x-2">
                        ...
                        <a href="{{ $lastOrder->nmArquivoDetalhes }}" download class="flex justify-center items-center border border-primary bg-transparent rounded-lg p-2 hover:bg-primary-100 active:bg-primary-200 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <svg class="size-5 xl:size-6 fill-primary" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <defs>
                                    <pattern id="pattern0_2617_4363" patternContentUnits="objectBoundingBox" width="1" height="1">
                                        <use xlink:href="#image0_2617_4363" transform="scale(0.0078125)"/>
                                    </pattern>
                        ...
                        <a href="{{ $lastOrder->nmArquivoNotaFiscal }}" download class="flex justify-center items-center border border-primary bg-transparent rounded-lg p-2 hover:bg-primary-100 active:bg-primary-200 focus:outline-none transition ease-in-out duration-150">
                            <svg class="size-5 xl:size-6 fill-primary" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <rect class="size-[21px]" fill="url(#pattern0_2617_4364)"/>
                                <defs>
                                    <pattern id="pattern0_2617_4364" patternContentUnits="objectBoundingBox" width="1" height="1">
                                        <use xlink:href="#image0_2617_4364" transform="scale(0.0078125)"/>
                                    </pattern>
    ...
    <div class="text-small font-medium mt-8">
