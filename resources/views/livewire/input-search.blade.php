<div x-data="{ inputText: '' }" class="relative flex items-center justify-center">
    ...
    <div class="absolute inset-y-0 left-50 flex items-center pointer-events-none" :class="{ 'hidden': inputText }">
        <svg class="fill-current text-subtitle-color size-5 me-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="font-light text-subtitle-color">{{ __('Search user') }}</div>    
    </div>
</div>
